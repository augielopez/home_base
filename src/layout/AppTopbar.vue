...
const { layoutState, isDarkTheme, toggleMenu, toggleConfigSidebar, toggleUiKitDrawer } = useLayout();
    ...
    <div class="layout-topbar">
        ...
        <div class="topbar-right">
            <ul class="topbar-menu">
                ...
                <li class="right-sidebar-item">
                    <button class="app-config-button cursor-pointer" @click="toggleConfigSidebar">
                        <i class="pi pi-cog" />
                    </button>
                </li>
                        ...
                        <ul class="flex flex-col gap-1">
                            ...
                            <li>
                                <a
                                    ...
                                    @click.prevent="toggleUiKitDrawer"
                                >
