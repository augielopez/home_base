...
const { layoutState, layoutConfig, isDarkTheme, changeMenuMode } = useLayout();
        ...
        <div class="flex flex-col gap-6">
            ...
            <div>
                ...
                <div class="pt-2 flex gap-2 flex-wrap">
                    ...
                    >
                        <i v-if="layoutConfig.surface ? layoutConfig.surface === surface.name : isDarkTheme ? surface.name === 'zinc' : surface.name === 'slate'" class="pi pi-check text-white" />
                    </button>
                </div>
            </div>
            ...
            <div v-if="!simple && location === 'app'" class="flex flex-col gap-2">
                <span class="text-lg text-muted-color font-semibold">Card Style</span>
                <SelectButton :modelValue="cardStyle" @change="onCardStyleChange" :options="cardStyleOptions" :allowEmpty="false" optionLabel="name" optionValue="value" />
            </div>

            <div v-if="!simple && location === 'app'" class="flex flex-col gap-2">
                <span class="text-lg text-muted-color font-semibold">Menu Theme</span>
                <SelectButton :modelValue="menuTheme" @change="onMenuThemeChange" :options="menuThemeOptions" :allowEmpty="false" optionLabel="name" optionValue="value" />
            </div>
