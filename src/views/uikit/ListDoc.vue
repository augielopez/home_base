                        ...
                        <div v-for="(item, index) in slotProps.items" :key="index">
                            <div class="flex flex-col sm:flex-row sm:items-center p-6 gap-4" :class="{ 'border-t border-surface': index !== 0 }">
                                <div class="md:w-40 relative">
                                    <span class="bg-linear-to-b dark:from-surface-950/70 from-30% dark:to-transparent w-full h-full absolute rounded" />
        ...
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <div class="lg:w-1/3">
                <div class="card">
                    ...
                    <OrderList v-model="orderlistProducts" breakpoint="1400px" dataKey="id" pt:pcListbox:root="w-full">
                        <template #option="{ option }">
                            {{ option.name }}
                        </template>
                    </OrderList>
