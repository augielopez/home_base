...
const shipping = ref(18.0);
const discount = ref(111.5);
const vat = ref(20.0);
const total = ref(909.97);
</script>
            ...
            <div class="max-w-6xl mx-auto p-6">
                <div class="flex justify-center items-start gap-2">
                    <div class="flex-1 flex justify-start items-center gap-6">
                        <div class="p-3.5 bg-emerald-400/25 rounded-full">
                            <div class="p-3.5 bg-emerald-400 rounded-full flex justify-center items-center">
                                <i class="pi pi-check text-emerald-50 text-lg" />
                            </div>
                        </div>
        ...
        <div class="max-w-6xl mx-auto px-6 py-8">
            <div class="grid grid-cols-1 xl:grid-cols-3 gap-8">
                <div class="xl:col-span-2 space-y-4">
                    <div class="space-y-4">
                        <div v-for="item in orderItems" :key="item.id" class="bg-white dark:bg-surface-800 rounded-xl p-4 flex gap-4">
                ...
                <div class="xl:col-span-1">
                    <div class="bg-white dark:bg-surface-800 rounded-2xl shadow-lg p-6 space-y-6 xl:-mt-32">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="w-full border-t border-surface-200 dark:border-surface-600 my-3" />
                        ...
                        <Button label="Download Invoice" class="w-full py-2.5 rounded-lg bg-primary-600 hover:bg-primary-700 text-white" />
                    </div>
                </div>
            </div>
        </div>
