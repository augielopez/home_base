                ...
                <div class="flex flex-col gap-16">
                    <div class="flex flex-col gap-8">
                        <p class="text-surface-500 dark:text-surface-300 text-lg leading-relaxed">
                            Manufacturing powerhouses serve as the backbone of global economic growth, creating jobs, driving innovation, and establishing supply chains that span continents. These industrial giants not only produce essential goods
                            but also fuel economic development through massive capital investments, technological advancement, and workforce development. Understanding their impact reveals how strategic manufacturing investments can reshape entire
                            economies and create lasting prosperity for communities worldwide.
                        </p>

                        <div class="flex items-start gap-4">
                            <div class="w-1 bg-surface-900 dark:bg-surface-100 rounded-full self-stretch" />
                            <div class="flex-1">
                        ...
                        <div class="flex-1 flex flex-col gap-3">
                            <div class="flex justify-between items-center">
                                ...
                                <div class="flex items-center gap-2">
                                    <Button icon="pi pi-youtube" severity="secondary" rounded />
                                    <Button icon="pi pi-twitter" severity="secondary" rounded />
                                    <Button icon="pi pi-facebook" severity="secondary" rounded />
                                </div>
                            </div>
                            <p class="text-surface-500 dark:text-surface-300 text-lg leading-relaxed">
            ...
            <div class="col-span-12 xl:col-span-4">
                <div class="flex flex-col">
                    <div class="flex justify-between items-center">
                        ...
                        <div class="flex items-center gap-2">
                            <Tag value="89" icon="pi pi-eye" severity="secondary" />
                            <Tag value="247" icon="pi pi-heart" severity="secondary" />
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col gap-8">
                        <div class="flex flex-col gap-4">
                            ...
                            <div class="flex flex-col gap-6">
                                <div v-for="comment in comments.slice(0, 3)" :key="comment.name" class="flex items-center gap-4">
                        ...
                        <Button outlined severity="secondary"> View Comments </Button>
                    </div>

                    <Divider class="my-7!" />

                    <div class="flex gap-2">
                        <Button icon="pi pi-youtube" severity="secondary" rounded class="flex-1 rounded-[7rem]!" />
                        <Button icon="pi pi-twitter" severity="secondary" rounded class="flex-1 rounded-[7rem]!" />
                        <Button icon="pi pi-facebook" severity="secondary" rounded class="flex-1 rounded-[7rem]!" />
                    </div>
                </div>
            </div>
        </div>
