    ...
    <div class="max-w-6xl mx-auto mt-16 flex flex-col md:flex-row items-start gap-6">
        <div class="card p-5 flex flex-col gap-3 md:max-w-80 w-full">
            <button
                ...
                :class="activeIndex === index ? 'bg-primary-600 text-surface-0' : 'hover:bg-emphasis text-surface-500 dark:text-surface-400'"
                class="px-3.5 py-2 rounded-lg label-medium text-base text-left transition-all"
            >
                {{ item.label }}
            </button>
        </div>
